...
public interface GameStateModule
{
	 ...
	 */
    void makeMove(final int x) throws RuntimeException;
	 ...
	 */
    int getWinner() throws RuntimeException;
	 ...
	 */
    int getAt(final int x, final int y);
